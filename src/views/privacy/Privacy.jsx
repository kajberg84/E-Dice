...
export const Privacy = () => {
  return (
    <div className={styles.privacy_container}>
      <Hero title="Privacy Policy of E-dice"></Hero>
      <div className={styles.privacy_wrapper}>
        <div className={styles.privacy_content_wrapper}>
          <h2>Privacy Policy</h2>
          <p>
            E-dice operates the localhost:3000 website, which provides the
            SERVICE.
          </p>
          ...
          <p>
            ...
            anyone decided to use our Service, the E-dice website.
          </p>
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at localhost:3000,
